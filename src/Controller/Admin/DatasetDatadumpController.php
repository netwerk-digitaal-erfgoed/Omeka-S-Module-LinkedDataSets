...
class DatasetDatadumpController extends AbstractActionController
{
    ...
    public function browseAction()
    {
        ...
        $formCrawlSelected
            ->setAttribute('action', $this->url()->fromRoute('admin/linked-data-sets/dataset-datadumps', ['action' => 'crawl-distribution-selected'], true))
        ...
        $formCrawlAll
            ->setAttribute('action', $this->url()->fromRoute('admin/linked-data-sets/dataset-datadumps', ['action' => 'crawl-distribution-all'], true))
